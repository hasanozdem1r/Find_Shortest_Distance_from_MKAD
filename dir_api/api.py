...
class YandexGeolocationApi:
    ...
    def get_geolocation(self,address:str) -> tuple:
        ...
        address_geolocation=address_json["response"]["GeoObjectCollection"]["featureMember"][0]["GeoObject"]["Point"]["pos"]
        address_geolocation=tuple(address_geolocation.split(" "))
        print(address_geolocation)

ya=YandexGeolocationApi("35253147-4db2-4d3a-8a22-b8be047d103f")
result_str=ya.search_by_address("Istanbul")
