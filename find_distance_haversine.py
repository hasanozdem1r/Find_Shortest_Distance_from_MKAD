class Distance:
    ...
    def __init__(self,geolocator_api_key="",distance_matrix_api_key=""):
        self._geolocator_api_key=geolocator_api_key
        self._distance_matrix_api_key=distance_matrix_api_key

    def distance_haversine(self,origin,destination):
        """
        distance find function use Haversine formula to determine distance between 2 geolocation.
